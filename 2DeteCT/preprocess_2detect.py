...
if __name__ == "__main__":
    ...
    ### Unpack arguments
    raw_folder_path = Path('/scratch/nadja/BenchS2I_2detect/BenchS2I-Benchmark-and-Extensions-of-Splitting-based-methods-for-Self-Supervised-Sparse-View-CT/LION/LION/data_loaders/2deteCT')
    processed_folder_path = Path('/scratch/nadja/BenchS2I_2detect/BenchS2I-Benchmark-and-Extensions-of-Splitting-based-methods-for-Self-Supervised-Sparse-View-CT/LION/LION/data_loaders/2deteCT_processed')
    ...
    for slice_index in tqdm(range(1, 1001)):
